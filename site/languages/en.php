...
'notification-discount' => 'Your discount code <strong><code>'.page(s::get('txn'))->discountcode().'</code></strong> will be applied at checkout.',
'notification-giftcertificate' => 'Your gift certificate <strong><code>'.page(s::get('txn'))->giftcertificatecode().'</code></strong> will be applied at checkout.',

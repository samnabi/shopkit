...
<nav class="uk-margin uk-text-center slideshow-nav">
	...
	<a class="uk-button" <?php if($product->hasPrevVisible()){ echo 'href="'.$product->prevVisible()->url().'/slide"'; } else { echo 'disabled'; } ?> >
	...
	<a class="uk-button" <?php if($product->hasNextVisible()){ echo 'href="'.$product->nextVisible()->url().'/slide"'; } else { echo 'disabled'; } ?> >
		<!-- Icon created by Appzgear http://www.flaticon.com/authors/appzgear -->

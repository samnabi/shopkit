<nav class="uk-grid uk-grid-collapse">
    ...
    <div class="uk-width-small-3-4 uk-width-medium-4-5 uk-width-large-5-6 uk-grid uk-grid-collapse">
        ...
        <?php foreach($pages->visible() as $p) { ?>
            ...
            <a class="uk-button uk-button-large uk-flex uk-flex-middle uk-flex-center <?php e($p->isOpen(), 'uk-active') ?> <?php echo $widths ?>" href="<?php echo $p->url() ?>">
    ...
    <div class="uk-width-small-1-4 uk-width-medium-1-5 uk-width-large-1-6 uk-grid uk-grid-collapse">
            ...
            <?php if ($user = $site->user()) { ?>
                <!-- Account -->
                <a href="<?php echo url('account') ?>" class="uk-button uk-button-small uk-button-contrast uk-width-1-3 uk-width-small-1-2 <?php e(page('account')->isOpen(), 'uk-active') ?>">
                    ...
                    <?php echo $user->firstname() != '' ? $user->firstname() : $user->username() ?>
                </a>
                
                <!-- Logout -->
                <a href="<?php echo url('logout') ?>" class="uk-button uk-button-small uk-button-contrast uk-width-1-3 uk-width-small-1-2">
